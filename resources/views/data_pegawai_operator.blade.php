...
<a href="{{ route('dashboard_operator') }}" class="{{ Request::routeIs('dashboard_operator') ? 'active' : '' }}">Dashboard</a>
    ...
    <div class="employee-actions">
        <form method="GET" action="{{ route('search_pegawai_operator') }}">
    <div class="search-wrapper">
        <input type="search" name="search" placeholder="Search" class="search-bar" value="{{ request('data_pegawai_operator') }}">
    ...
    <tbody>
        @foreach ($dtPegawai as $item)
            ...
            <td>{{ $loop->iteration }}</td>
                ...
                <td>{{ $item->email }}</td> -->
                <td>
                    <a href="{{url('edit_data_pegawai_operator/'.$item->id)}}"><i class="fas fa-edit"></i></a>
                    <a href="{{url('info_datapeg_operator/'.$item->id)}}"><i class="fas fa-info-circle" style="color: blue;"></i></a>
