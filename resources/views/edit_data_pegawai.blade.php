...
<div class="container">
    ...
    <form action="/update_data_pegawai/{{ $pegawai->id }}" method="POST">
        @csrf
        @method('PUT')
        ...
        <input type="text" id="fullName" name="nama" value="{{ $pegawai->nama }}" required>

        <label for="nip">NIP:</label>
        <input type="text" id="nip" name="nip" value="{{ $pegawai->nip }}" required>

        <label for="birthPlace">Tempat Lahir:</label>
        <input type="text" id="birthPlace" name="tmpt_lahir" value="{{ $pegawai->tmpt_lahir }}" required>

        <label for="birthDate">Tanggal Lahir:</label>
        <input type="date" id="birthDate" name="tgl_lahir" value="{{ $pegawai->tgl_lahir }}" required>

        <label for="tmt">TMT:</label>
        <input type="date" id="tmt" name="tmt" value="{{ $pegawai->tmt }}" required>

        <label for="education">Pendidikan Terakhir:</label>
        <input type="text" id="education" name="pendidikan" value="{{ $pegawai->pendidikan }}" required>

        <label for="year">Tahun:</label>
        <input type="text" id="year" name="tahun" value="{{ $pegawai->tahun }}" required>
        ...
        <input type="text" id="nik" name="nik" value="{{ $pegawai->nik }}" required>

        <label for="position">Jabatan:</label>
        <input type="text" id="position" name="jabatan" value="{{ $pegawai->jabatan }}" required>
        ...
        <input type="text" id="phone" name="no_tlp" value="{{ $pegawai->no_tlp }}" required>
