...
Route::get('/rekap_absen_user', [AbsensiController::class, 'rekapAbsensi'])->name('rekap_absen_user');
});
...
Route::get('/rekap_kehadiran_operator', [AbsensiController::class, 'rekapAbsen'])->name('rekap_kehadiran_operator');
...
Route::get('/profil_user', [AuthenticatedSessionController::class, 'showChangePasswordForm'])
    ->name('profil_user')
    ->middleware('auth');
    Route::get('/dashboard_user', [DashboardUserController::class, 'index'])->name('dashboard_user');

Route::post('/update_password', [AuthenticatedSessionController::class, 'updatePassword'])
    ->name('update_password')
    ->middleware('auth');
        Route::get('/edit_data_user', [PegawaiController::class, 'edit'])->name('edit_data_user');
        Route::put('/update_user', [PegawaiController::class, 'update'])->name('update_user');
        Route::get('/dashboard_user', [AbsensiController::class, 'rekapAbsensiDashboard'])->name('dashboard_user');
