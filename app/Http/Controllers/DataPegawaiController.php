    ...
    public function store(Request $request)
{
    ...
    public function rekapAbsen(Request $request, $bulan = null, $tahun = null)
    {
        ...
        $absensi = [];
        if ($request->route()->getName() === 'table_rekap_kehadiran') {
            ...
            return view('table_rekap_kehadiran', compact('absensi', 'namaBulan', 'tahun', 'bulan'));
        }
    
        // Kembalikan rekap kehadiran operator ke view
        return view('rekap_kehadiran', compact('namaBulan', 'tahun', 'bulan'));
    }
    ...
    public function rekapitulasi()
    {
        ...
        return view('table_cuti_admin', ['pengajuanCuti' => $pengajuanCuti]);
    }
